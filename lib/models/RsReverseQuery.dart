...
RsReversQuery rsReversQueryFromJson(String str) =>
    RsReversQuery.fromJson(json.decode(str));
String rsReversQueryToJson(RsReversQuery data) => json.encode(data.toJson());
...
class RsReversQuery {
  ...
  factory RsReversQuery.fromJson(Map<String, dynamic> json) => RsReversQuery(
        type: json["type"],
