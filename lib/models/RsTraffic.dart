...
RsTraffic rsTrafficFromJson(String str) => RsTraffic.fromJson(json.decode(str));

String rsTrafficToJson(RsTraffic data) => json.encode(data.toJson());
...
class RsTraffic {
    ...
    factory RsTraffic.fromJson(Map<String, dynamic> json) => RsTraffic(
